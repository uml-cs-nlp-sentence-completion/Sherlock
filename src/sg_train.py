...
def build_model(sentences, model_name):
    num_features    = 640   # 640 Word vector dimensionality
...
if __name__ == '__main__':
    ...
    file_anmes  = args.file_names
    model_name  = args.model[0]
    sentences   = Sentences(file_anmes) # a memory-friendly iterator
